...
"MISC": {
 ...
 "Ajar (reward)":								"Ajar"
	...
	var URL_TEMPLATE = 'http://www.everyayah.com/data/$1/$2.mp3', //'http://audio.allahsquran.com/vbv/arabic/$1/$2.mp3', 
																			//http://www.everyayah.com/data/Alafasy_64kbps/024001.mp3
	...
	var RECITORS = [
		'Alafasy_64kbps', //THIS IS DEFAULT  'mishary_al-afasi',
		'Abdul_Basit_Murattal_64kbps', //'abdul-basit_murattal',
		'Abdul_Basit_Mujawwad_128kbps', //'abdul-basit_mujawwad',
		'Husary_64kbps', //'khalil_al-husari_murattal',
		'Husary_Mujawwad_64kbps' //'khalil_al-husari_mujawwad'
	], RECITORS2 = [
	...
	var getQuranPlayer = function(ref, RECITOR){
		...
		if(typeof(RECITORS) != NULL && RECITORS)
			for(key in RECITORS){
				...
				tmp = (UI_isIphone() || key!=0 ) ? '&nbsp;&nbsp;' : TEMPLATE.replace(/\$URL/i, URL);	
